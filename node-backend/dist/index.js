...
var DB = process.env.NODE_ENV == "development" ? process.env.mongo_dev_url : process.env.mongo_url;
...
initialize().then(function(_) {
    console.log("server is online on PORT:".concat(PORT));
});
