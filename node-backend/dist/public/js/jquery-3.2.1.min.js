...
!function(a, b) {
    ...
    var w = function w(a) {
        var _$b = !!a && "length" in a && a.length, c = r.type(a);
        return "function" !== c && !r.isWindow(a) && ("array" === c || 0 === _$b || "number" == typeof _$b && _$b > 0 && _$b - 1 in a);
    };
    ...
    var fa = function fa(a, b, c, d) {
        var e, f = 1, g = 20, h = d ? function h() {
            return d.cur();
        } : function() {
            return r.css(a, b, "");
    ...
    var ha = function ha(a) {
        var _$b, c = a.ownerDocument, d = a.nodeName, e = ga[d];
        return e ? e : (_$b = c.body.appendChild(c.createElement(d)), e = r.css(_$b, "display"), _$b.parentNode.removeChild(_$b), "none" === e && (e = "block"), ga[d] = e, e);
    };
    ...
    var Wa = function Wa(a) {
        if (a in Va) return a;
        var _$b = a[0].toUpperCase() + a.slice(1), c = Ua.length;
    ...
    var q = "3.2.1", r = function r1(a, b) {
        return new r.fn.init(a, b);
    }, s = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, t = /^-ms-/, u = /-([a-z])/g, v = function v(a, b) {
    ...
    r.fn = r.prototype = {
        ...
        eq: function eq(a) {
            var _$b = this.length, c = +a + (a < 0 ? _$b : 0);
        ...
        for("boolean" == typeof g && (j = g, g = arguments[h] || {}, h++), "object" == typeof g || r.isFunction(g) || (g = {}), h === i && (g = this, h--); h < i; h++)if (null != (_$a = arguments[h])) for(_$b in _$a)c = g[_$b], d = _$a[_$b], g !== d && (j && d && (r.isPlainObject(d) || (e = Array.isArray(d))) ? (e ? (e = !1, f = c && Array.isArray(c) ? c : []) : f = c && r.isPlainObject(c) ? c : {}, g[_$b] = r.extend(j, f, d)) : void 0 !== d && (g[_$b] = d));
        return g;
    }, r.extend({
        ...
        isNumeric: function isNumeric(a) {
            var _$b = r.type(a);
            return ("number" === _$b || "string" === _$b) && !isNaN(a - parseFloat(a));
        },
        isPlainObject: function isPlainObject(a) {
            var _$b, c;
            return !(!a || "[object Object]" !== k.call(a)) && (!(_$b = e(a)) || (c = l.call(_$b, "constructor") && _$b.constructor, "function" == typeof c && m.call(c) === n));
        },
        ...
        type: function type(a) {
            return null == a ? a + "" : "object" == typeof a || "function" == typeof a ? j[k.call(a)] || "object" : typeof a === "undefined" ? "undefined" : _typeof(a);
        },
    ...
    var x = function(a) {
        ...
        var wa = function wa(a, b, c, d, e) {
            for(var f, g = [], h = 0, i = a.length, j = null != b; h < i; h++)(f = a[h]) && (c && !c(f, d, e) || (g.push(f), j && b.push(h)));
            return g;
        };
        var za = function za(a, b) {
            var c = b.length > 0, e = a.length > 0, f = function f(f, g, h, i, k) {
        ...
        var _$b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u = "sizzle" + 1 * new Date, v = a.document, w = 0, x = 0, y = ha(), z = ha(), A = ha(), B = function B(a, b) {
            return a === b && (l = !0), 0;
        }, C = {}.hasOwnProperty, D = [], E = D.pop, F = D.push, G = D.push, H = D.slice, I = function I(a, b) {
            for(var c = 0, d = a.length; c < d; c++)if (a[c] === b) return c;
            return -1;
        }, J = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", K = "[\\x20\\t\\r\\n\\f]", L = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", M = "\\[" + K + "*(" + L + ")(?:" + K + "*([*^$|!~]?=)" + K + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + L + "))|)" + K + "*\\]", N = ":(" + L + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + M + ")*)|.*)\\)|)", O = new RegExp(K + "+", "g"), P = new RegExp("^" + K + "+|((?:^|[^\\\\])(?:\\\\.)*)" + K + "+$", "g"), Q = new RegExp("^" + K + "*," + K + "*"), R = new RegExp("^" + K + "*([>+~]|" + K + ")" + K + "*"), _$S = new RegExp("=" + K + "*([^\\]'\"]*?)" + K + "*\\]", "g"), T = new RegExp(N), U = new RegExp("^" + L + "$"), _$V = {
            ID: new RegExp("^#(" + L + ")"),
            CLASS: new RegExp("^\\.(" + L + ")"),
            TAG: new RegExp("^(" + L + "|[*])"),
            ATTR: new RegExp("^" + M),
        ...
        }, W = /^(?:input|select|textarea|button)$/i, X = /^h\d$/i, Y = /^[^{]+\{\s*\[native \w/, Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, $ = /[+~]/, _ = new RegExp("\\\\([\\da-f]{1,6}" + K + "?|(" + K + ")|.)", "ig"), aa = function aa(a, b, c) {
            var d = "0x" + b - 65536;
            return d !== d || c ? b : d < 0 ? String.fromCharCode(d + 65536) : String.fromCharCode(d >> 10 | 55296, 1023 & d | 56320);
        }, ba = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, ca = function ca(a, b) {
        ...
        c = ga.support = {}, f = ga.isXML = function f(a) {
            ...
            return !!_$b && "HTML" !== _$b.nodeName;
        }, m = ga.setDocument = function m(a) {
            var _$b, e, g = a ? a.ownerDocument || a : v;
            return g !== n && 9 === g.nodeType && g.documentElement ? (n = g, o = n.documentElement, p = !f(n), v !== n && (e = n.defaultView) && e.top !== e && (e.addEventListener ? e.addEventListener("unload", da, !1) : e.attachEvent && e.attachEvent("onunload", da)), c.attributes = ja(function(a) {
                ...
                _$b.setAttribute("type", "hidden"), a.appendChild(_$b).setAttribute("name", "D"), a.querySelectorAll("[name=d]").length && q.push("name" + K + "*[*^$|!~]?="), 2 !== a.querySelectorAll(":enabled").length && q.push(":enabled", ":disabled"), o.appendChild(a).disabled = !0, 2 !== a.querySelectorAll(":disabled").length && q.push(":enabled", ":disabled"), a.querySelectorAll("*,:x"), q.push(",.*:");
            ...
            filter: {
                ...
                CLASS: function CLASS(a) {
                    ...
                    return _$b || (_$b = new RegExp("(^|" + K + ")" + a + "(" + K + "|$)")) && y(a, function(a) {
                        return _$b.test("string" == typeof a.className && a.className || "undefined" != typeof a.getAttribute && a.getAttribute("class") || "");
                    });
                },
    ...
    r.filter = function(a, b, c) {
        ...
        find: function find(a) {
            var _$b, c, d = this.length, e = this;
    ...
    var F, G = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, H = r.fn.init = function H(a, b, c) {
        var e, f;
        if (!a) return this;
    ...
    r.Callbacks = function(a) {
        ...
        var _$b, c, d, e, f = [], g = [], h = -1, i = function i() {
    ...
    r.extend({
        Deferred: function Deferred(b) {
            var c = [
                ...
                then: function then(b, d, e) {
                    ...
                    function g(b, c, d, e) {
                        return function() {
                            var h = this, i = arguments, j = function j() {
                                var _$a, j;
                                if (!(b < f)) {
                                    if (_$a = d.apply(h, i), _$a === c.promise()) throw new TypeError("Thenable self-resolution");
                                    j = _$a && ("object" == typeof _$a || "function" == typeof _$a) && _$a.then, r.isFunction(j) ? e ? j.call(_$a, g(f, c, N, e), g(f, c, O, e)) : (f++, j.call(_$a, g(f, c, N, e), g(f, c, O, e), g(f, c, N, c.notifyWith))) : (d !== N && (h = void 0, i = [
                                        _$a
                                    ]), (e || c.resolveWith)(h, i));
                                }
                            }, k = e ? j : function k1() {
        ...
        when: function when(a) {
            var _$b = arguments.length, c = _$b, d = Array(c), e = f.call(arguments), g = r.Deferred(), h = function h(a) {
                return function(c) {
                    d[a] = this, e[a] = arguments.length > 1 ? f.call(arguments) : c, --_$b || g.resolveWith(d, e);
                };
            };
            if (_$b <= 1 && (P(a, g.done(h(c)).resolve, g.reject, !_$b), "pending" === g.state() || r.isFunction(e[c] && e[c].then))) return g.then();
    ...
    r.extend({
        ...
        dequeue: function dequeue(a, b) {
            b = b || "fx";
            var c = r.queue(a, b), d = c.length, e = c.shift(), f = r._queueHooks(a, b), g = function g() {
                r.dequeue(a, b);
            };
        ...
        promise: function promise(a, b) {
            var c, d = 1, e = r.Deferred(), f = this, g = this.length, h = function h() {
                --d || e.resolveWith(f, [
                    f
                ]);
            };
    ...
    var pa = /<|&#?\w+;/;
    !function() {
        var _$a = d.createDocumentFragment(), _$b = _$a.appendChild(d.createElement("div")), c = d.createElement("input");
    ...
    r.event = {
        ...
        dispatch: function dispatch(a) {
            var _$b = r.event.fix(a), c, d, e, f, g, h, i = new Array(arguments.length), j = (W.get(this, "events") || {})[_$b.type] || [], k = r.event.special[_$b.type] || {};
        ...
        return _instanceof(this, r.Event) ? (a && a.type ? (this.originalEvent = a, this.type = a.type, this.isDefaultPrevented = a.defaultPrevented || void 0 === a.defaultPrevented && a.returnValue === !1 ? va : wa, this.target = a.target && 3 === a.target.nodeType ? a.target.parentNode : a.target, this.currentTarget = a.currentTarget, this.relatedTarget = a.relatedTarget) : this.type = a, b && r.extend(this, b), this.timeStamp = a && a.timeStamp || r.now(), void (this[r.expando] = !0)) : new r.Event(a, b);
    }, r.Event.prototype = {
        constructor: r.Event,
        ...
        which: function which(a) {
            var _$b = a.button;
            return null == a.which && sa.test(a.type) ? null != a.charCode ? a.charCode : a.keyCode : !a.which && void 0 !== _$b && ta.test(a.type) ? 1 & _$b ? 1 : 2 & _$b ? 3 : 4 & _$b ? 2 : 0 : a.which;
        }
    ...
    r.extend({
        ...
        empty: function empty() {
            for(var _$a, _$b = 0; null != (_$a = this[_$b]); _$b++)1 === _$a.nodeType && (r.cleanData(na(_$a, !1)), _$a.textContent = "");
            return this;
        },
        ...
        html: function html(a) {
            return T(this, function(a) {
                ...
                if (void 0 === a && 1 === _$b.nodeType) return _$b.innerHTML;
                if ("string" == typeof a && !Aa.test(a) && !ma[(ka.exec(a) || [
                    ...
                    a = r.htmlPrefilter(a);
                    try {
                        for(; c < d; c++)_$b = this[c] || {}, 1 === _$b.nodeType && (r.cleanData(na(_$b, !1)), _$b.innerHTML = a);
                        _$b = 0;
                    } catch (e) {}
                }
    ...
    var La = /^margin/, Ma = new RegExp("^(" + aa + ")(?!px)[a-z%]+$", "i"), Na = function Na(b) {
    ...
    !function() {
        var _$b = function _$b() {
            if (i) {
                ...
                c = "1%" !== _$b.top, g = "2px" === _$b.marginLeft, e = "4px" === _$b.width, i.style.marginRight = "50%", f = "4px" === _$b.marginRight, ra.removeChild(h), i = null;
            }
        };
    ...
    r.Tween = _a, _a.prototype = {
        ...
        run: function run(a) {
            var _$b, c = _a.propHooks[this.prop];
        ...
        _default: {
            get: function get(a) {
                var _$b;
                return 1 !== a.elem.nodeType || null != a.elem[a.prop] && null == a.elem.style[a.prop] ? a.elem[a.prop] : (_$b = r.css(a.elem, a.prop, ""), _$b && "auto" !== _$b ? _$b : 0);
            },
            set: function set(a) {
    ...
    r.Animation = r.extend(kb, {
        ...
        animate: function animate(a, b, c, d) {
            var e = r.isEmptyObject(a), f = r.speed(b, c, d), g = function g() {
        ...
        stop: function stop(a, b, c) {
            ...
            return "string" != typeof a && (c = b, b = a, a = void 0), b && a !== !1 && this.queue(a || "fx", []), this.each(function() {
                var _$b = !0, e = null != a && a + "queueHooks", f = r.timers, g = W.get(this);
        ...
        finish: function finish(a) {
            return a !== !1 && (a = a || "fx"), this.each(function() {
                var _$b, c = W.get(this), d = c[a + "queue"], e = c[a + "queueHooks"], f = r.timers, g = d ? d.length : 0;
        ...
        var _$a = d.createElement("input"), _$b = d.createElement("select"), c = _$b.appendChild(d.createElement("option"));
        _$a.type = "checkbox", o.checkOn = "" !== _$a.value, o.optSelected = c.selected, _$a = d.createElement("input"), _$a.value = "t", _$a.type = "radio", o.radioValue = "t" === _$a.value;
    }();
    ...
    r.fn.extend({
        ...
        toggleClass: function toggleClass(a, b) {
            ...
            return "boolean" == typeof b && "string" === c ? b ? this.addClass(a) : this.removeClass(a) : r.isFunction(a) ? this.each(function(c) {
                ...
                } else void 0 !== a && "boolean" !== c || (_$b = qb(this), _$b && W.set(this, "__className__", _$b), this.setAttribute && this.setAttribute("class", _$b || a === !1 ? "" : W.get(this, "__className__") || ""));
            });
        },
        hasClass: function hasClass(a) {
            var _$b, c, d = 0;
            _$b = " " + a + " ";
            while(c = this[d++])if (1 === c.nodeType && (" " + pb(qb(c)) + " ").indexOf(_$b) > -1) return !0;
            return !1;
        }
    });
    var rb = /\r/g;
    r.fn.extend({
        val: function val(a) {
            var _$b, c, d, e = this[0];
            {
                ...
                if (e) return _$b = r.valHooks[e.type] || r.valHooks[e.nodeName.toLowerCase()], _$b && "get" in _$b && void 0 !== (c = _$b.get(e, "value")) ? c : (c = e.value, "string" == typeof c ? c.replace(rb, "") : null == c ? "" : c);
            }
        }
    }), r.extend({
        valHooks: {
            option: {
                get: function get(a) {
                    ...
                    return null != _$b ? _$b : pb(r.text(a));
                }
            },
            select: {
                get: function get(a) {
                    var _$b, c, d, e = a.options, f = a.selectedIndex, g = "select-one" === a.type, h = g ? null : [], i = g ? f + 1 : e.length;
            ...
            return {
                send: function send(e, f) {
                    _$b = r("<script>").prop({
                        ...
                        _$b.remove(), c = null, a && f("error" === a.type ? 404 : 200, a.type);
    ...
    r.ajaxSetup({
        ...
        return _$a.innerHTML = "<form></form><form></form>", 2 === _$a.childNodes.length;
        ...
        position: function position() {
            if (this[0]) {
                var _$a, _$b, c = this[0], d = {
                    top: 0,
                    left: 0
                };
                return "fixed" === r.css(c, "position") ? _$b = c.getBoundingClientRect() : (_$a = this.offsetParent(), _$b = this.offset(), B(_$a[0], "html") || (d = _$a.offset()), d = {
        ...
        offsetParent: function offsetParent() {
            return this.map(function() {
                ...
                while(_$a && "static" === r.css(_$a, "position"))_$a = _$a.offsetParent;
                return _$a || ra;
            });
        }
    }), r.each({
        ...
        r.each({
            ...
            r.fn[d] = function(e, f) {
                ...
                return T(this, function(b, c, e) {
                    var _$f;
                    return r.isWindow(b) ? 0 === d.indexOf("outer") ? b["inner" + a] : b.document.documentElement["client" + a] : 9 === b.nodeType ? (_$f = b.documentElement, Math.max(b.body["scroll" + a], _$f["scroll" + a], b.body["offset" + a], _$f["offset" + a], _$f["client" + a])) : void 0 === e ? r.css(b, c, h) : r.style(b, c, e, h);
                }, b, g ? e : void 0, g);
            };
        });
    }), r.fn.extend({
