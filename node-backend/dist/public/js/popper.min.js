 ...
 */ (function(e, t) {
    ...
    var v = function v(e, t, o, i, n) {
        ...
        var p = w(o, i, r, n), s = {
            ...
            var _$t = e.width, _$i = e.height;
            return _$t >= o.clientWidth && _$i >= o.clientHeight;
        }), l = 0 < a.length ? a[0].key : d[0].key, f = e.split("-")[1];
        return l + (f ? "-" + f : "");
    };
    var x = function x(e, t, o) {
        var i = d(t, o);
        return u(o, i);
    };
    var O = function O(e) {
    ...
    var N = function N(t, o, i) {
        var n = void 0 === i ? t : t.slice(0, C(t, "name", i));
        return n.forEach(function(t) {
            t.function && console.warn("`modifier.function` is deprecated, use `modifier.fn`!");
            var _$i = t.function || t.fn;
            t.enabled && e(_$i) && (o.offsets.popper = h(o.offsets.popper), o.offsets.reference = h(o.offsets.reference), o = _$i(o, t));
        }), o;
    };
    var k = function k() {
    ...
    for(var V = Math.min, _ = Math.floor, X = Math.max, Q = [
        ...
        "Trident",
        "Firefox"
    ], ee = 0, te = 0; te < $.length; te += 1)if (Z && 0 <= navigator.userAgent.indexOf($[te])) {
        ee = 1;
        break;
    }
    var i, oe = Z && J(window.MutationObserver), ie = oe ? function ie(e) {
    ...
    return me.Utils = ("undefined" == typeof window ? global : window).PopperUtils, me.placements = ae, me.Defaults = {
        ...
        modifiers: {
            ...
            keepTogether: {
                ...
                enabled: !0,
                fn: function fn(e) {
                    var t = e.offsets, o = t.popper, i = t.reference, n = e.placement.split("-")[0], r = _, p = -1 !== [
                        "top",
                        "bottom"
            ...
            arrow: {
                ...
                fn: function fn(e, o) {
                    ...
                    var n = e.placement.split("-")[0], r = e.offsets, p = r.popper, s = r.reference, d = -1 !== [
                        "left",
                        "right"
                    ].indexOf(n), a = d ? "height" : "width", l = d ? "Top" : "Left", f = l.toLowerCase(), m = d ? "left" : "top", c = d ? "bottom" : "right", g = O(i)[a];
            ...
            flip: {
                ...
                fn: function fn(e, t) {
                    ...
                    return p.forEach(function(s, d) {
                        ...
                        var a = e.offsets.popper, l = e.offsets.reference, f = _, m = "left" === i && f(a.right) > f(l.left) || "right" === i && f(a.left) < f(l.right) || "top" === i && f(a.bottom) > f(l.top) || "bottom" === i && f(a.top) < f(l.bottom), c = f(a.left) < f(o.left), h = f(a.right) > f(o.right), g = f(a.top) < f(o.top), u = f(a.bottom) > f(o.bottom), b = "left" === i && c || "right" === i && h || "top" === i && g || "bottom" === i && u, y = -1 !== [
                            "top",
                            "bottom"
                        ].indexOf(i), w = !!t.flipVariations && (y && "start" === r && c || y && "end" === r && h || !y && "start" === r && g || !y && "end" === r && u);
