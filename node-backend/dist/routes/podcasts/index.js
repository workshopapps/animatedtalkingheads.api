...
const { podcastuploader , getOnePodcast , getAllUserUploadedPodcast , generateAnimatedVideos , deletePodcast  } = require('../../controllers/podcast.controller');
const { getOneAnimatedVideo , getAllUserCreatedAnimatedVideos  } = require('../../controllers/animatedvideo.controller');
