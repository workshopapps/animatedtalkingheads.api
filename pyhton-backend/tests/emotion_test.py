'''The expected output is one emotion that best represents the sentence
    incase of a dry sentence we handle it on images side
'''
...
#---------------------------RUNNING THIS SCRIPT----------------------------------#
#Libraries :-----> pip install text2emotion
#   Error(count1) :-----> UNICODE_EMOJI
...
# sentence = 'today is so cool'
#output :-----> Please uncomment the preceding print statements
