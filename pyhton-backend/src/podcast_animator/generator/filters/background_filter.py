            ...
            if (
                ...
                for i in range(len(self.bg_sq_files["01"])):
                    if i + counter > self.animation_frame_length:
                        break
                    self.animation_frames.update(
                        {str(i + counter): self.bg_sq_files["01"][i]}
                    )
